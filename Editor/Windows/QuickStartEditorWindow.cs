        ...
        public void CreateGUI() {
            ...
            var tutorials = new TutorialInfo[] {
                new TutorialInfo() {
                    ...
                    texture = EditorUtils.LoadResource<Texture2D>("ME.BECS.Resources/QuickStart/Textures/tutorial-1.jpg"),
                },
                new TutorialInfo() {
                    caption = "Basics",
                    description = "Core API, entities API, how to read and write data.",
                    url = "https://youtu.be/5clulSSIrco",
                    texture = EditorUtils.LoadResource<Texture2D>("ME.BECS.Resources/QuickStart/Textures/tutorial-2.jpg"),
                },
                new TutorialInfo() {
                    caption = "Views",
                    description = "How to create and use views.",
                    url = "https://youtu.be/PWGOLubeh3k",
                    texture = EditorUtils.LoadResource<Texture2D>("ME.BECS.Resources/QuickStart/Textures/tutorial-3.jpg"),
                },
                new TutorialInfo() {
                    ...
                    texture = EditorUtils.LoadResource<Texture2D>("ME.BECS.Resources/QuickStart/Textures/tutorial-4.jpg"),
                },
                new TutorialInfo() {
                    caption = "Entity Configs",
                    description = "How to use Entity Configs with different joins.",
                    url = "https://youtu.be/vItAprfcc0A",
                    texture = EditorUtils.LoadResource<Texture2D>("ME.BECS.Resources/QuickStart/Textures/tutorial-5.jpg"),
                },
                new TutorialInfo() {
                    ...
                    texture = EditorUtils.LoadResource<Texture2D>("ME.BECS.Resources/QuickStart/Textures/tutorial-6.jpg"),
                },
                new TutorialInfo() {
                    ...
                    texture = EditorUtils.LoadResource<Texture2D>("ME.BECS.Resources/QuickStart/Textures/tutorial-7.jpg"),
                },
                new TutorialInfo() {
                    caption = "Trees",
                    description = "How to use Trees queries.",
                    url = "https://youtu.be/TilgB9G1G3g",
                    texture = EditorUtils.LoadResource<Texture2D>("ME.BECS.Resources/QuickStart/Textures/tutorial-8.jpg"),
                },
            };
